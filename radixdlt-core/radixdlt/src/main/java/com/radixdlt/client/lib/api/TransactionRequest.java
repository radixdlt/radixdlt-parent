...
public class TransactionRequest {
	...
	public static final class TransactionRequestBuilder {
		...
		public TransactionRequestBuilder transfer(REAddr from, REAddr to, UInt256 amount, String rri) {
			actions.add(ActionDTO.transfer(from, to, amount, rri));
			return this;
		}

		public TransactionRequestBuilder stake(REAddr from, REAddr validator, UInt256 amount) {
			actions.add(ActionDTO.stake(from, validator, amount));
			return this;
		}

		public TransactionRequestBuilder unstake(REAddr from, REAddr validator, UInt256 amount) {
